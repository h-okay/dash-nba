...
hs = headshotCards("Los Angeles Lakers")
n_buttons = get_button_count("Los Angeles Lakers")
team_ = "Los Angeles Lakers"

layout = dbc.Container(
    [
        dcc.Store(id="store-id11"),
        dcc.Store(id="worth-id11"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Los Angeles Lakers')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Los Angeles Lakers", 0),
                                drawCard("Los Angeles Lakers", 1),
                                drawCard("Los Angeles Lakers", 2),
                                drawCard("Los Angeles Lakers", 3),
                                drawCard("Los Angeles Lakers", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Los Angeles Lakers"),
                        dbc.Card(
                            current_team_stats("Los Angeles Lakers"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Los Angeles Lakers"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Los Angeles Lakers"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Los Angeles Lakers"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder41"),
                dbc.Col(children=[], width=9, id="placeholder42"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Los Angeles Lakers"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder43", width=3),
                dbc.Col([], id="placeholder44", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Los Angeles Lakers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Los Angeles Lakers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Los Angeles Lakers")])]),
    ],
...
@app.callback(Output("placeholder41", "children"), [Input("store-id11", "data")])
...
@app.callback(Output("placeholder42", "children"), [Input("store-id11", "data")])
...
@app.callback(Output("placeholder43", "children"), [Input("worth-id11", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder44", "children"), [Input("worth-id11", "data")])
