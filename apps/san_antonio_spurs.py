...
hs = headshotCards("San Antonio Spurs")
n_buttons = get_button_count("San Antonio Spurs")
team_ = "San Antonio Spurs"

layout = dbc.Container(
    [
        dcc.Store(id="store-id23"),
        dcc.Store(id="worth-id23"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('San Antonio Spurs')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("San Antonio Spurs", 0),
                                drawCard("San Antonio Spurs", 1),
                                drawCard("San Antonio Spurs", 2),
                                drawCard("San Antonio Spurs", 3),
                                drawCard("San Antonio Spurs", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("San Antonio Spurs"),
                        dbc.Card(
                            current_team_stats("San Antonio Spurs"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("San Antonio Spurs"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("San Antonio Spurs"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("San Antonio Spurs"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder88"),
                dbc.Col(children=[], width=9, id="placeholder89"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("San Antonio Spurs"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder90", width=3),
                dbc.Col([], id="placeholder91", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("San Antonio Spurs")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("San Antonio Spurs")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("San Antonio Spurs")])]),
    ],
...
@app.callback(Output("placeholder89", "children"), [Input("store-id23", "data")])
...
@app.callback(Output("placeholder90", "children"), [Input("store-id23", "data")])
...
@app.callback(Output("placeholder91", "children"), [Input("worth-id23", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder92", "children"), [Input("worth-id23", "data")])
