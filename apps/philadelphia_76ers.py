...
hs = headshotCards("Philadelphia 76ers")
n_buttons = get_button_count("Philadelphia 76ers")
team_ = "Philadelphia 76ers"

layout = dbc.Container(
    [
        dcc.Store(id="store-id19"),
        dcc.Store(id="worth-id19"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Philadelphia 76ers')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Philadelphia 76ers", 0),
                                drawCard("Philadelphia 76ers", 1),
                                drawCard("Philadelphia 76ers", 2),
                                drawCard("Philadelphia 76ers", 3),
                                drawCard("Philadelphia 76ers", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Philadelphia 76ers"),
                        dbc.Card(
                            current_team_stats("Philadelphia 76ers"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Philadelphia 76ers"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Philadelphia 76ers"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Philadelphia 76ers"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder73"),
                dbc.Col(children=[], width=9, id="placeholder74"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Philadelphia 76ers"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder75", width=3),
                dbc.Col([], id="placeholder76", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Philadelphia 76ers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Philadelphia 76ers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Philadelphia 76ers")])]),
    ],
...
@app.callback(Output("placeholder73", "children"), [Input("store-id19", "data")])
...
@app.callback(Output("placeholder74", "children"), [Input("store-id19", "data")])
...
@app.callback(Output("placeholder75", "children"), [Input("worth-id19", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder76", "children"), [Input("worth-id19", "data")])
