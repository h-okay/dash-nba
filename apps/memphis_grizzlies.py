...
hs = headshotCards("Memphis Grizzlies")
n_buttons = get_button_count("Memphis Grizzlies")
team_ = "Memphis Grizzlies"

layout = dbc.Container(
    [
        dcc.Store(id="store-id27"),
        dcc.Store(id="worth-id27"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Memphis Grizzlies')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Memphis Grizzlies", 0),
                                drawCard("Memphis Grizzlies", 1),
                                drawCard("Memphis Grizzlies", 2),
                                drawCard("Memphis Grizzlies", 3),
                                drawCard("Memphis Grizzlies", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Memphis Grizzlies"),
                        dbc.Card(
                            current_team_stats("Memphis Grizzlies"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Memphis Grizzlies"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Memphis Grizzlies"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Memphis Grizzlies"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder105"),
                dbc.Col(children=[], width=9, id="placeholder106"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Memphis Grizzlies"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder107", width=3),
                dbc.Col([], id="placeholder108", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Memphis Grizzlies")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Memphis Grizzlies")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Memphis Grizzlies")])]),
    ],
...
@app.callback(Output("placeholder105", "children"), [Input("store-id27", "data")])
...
@app.callback(Output("placeholder106", "children"), [Input("store-id27", "data")])
...
@app.callback(Output("placeholder107", "children"), [Input("worth-id27", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder108", "children"), [Input("worth-id27", "data")])
