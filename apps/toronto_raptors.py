...
hs = headshotCards("Toronto Raptors")
n_buttons = get_button_count("Toronto Raptors")
team_ = "Toronto Raptors"

layout = dbc.Container(
    [
        dcc.Store(id="store-id25"),
        dcc.Store(id="worth-id25"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Toronto Raptors')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Toronto Raptors", 0),
                                drawCard("Toronto Raptors", 1),
                                drawCard("Toronto Raptors", 2),
                                drawCard("Toronto Raptors", 3),
                                drawCard("Toronto Raptors", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Toronto Raptors"),
                        dbc.Card(
                            current_team_stats("Toronto Raptors"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Toronto Raptors"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Toronto Raptors"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Toronto Raptors"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder97"),
                dbc.Col(children=[], width=9, id="placeholder98"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Toronto Raptors"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder99", width=3),
                dbc.Col([], id="placeholder100", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Toronto Raptors")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Toronto Raptors")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Toronto Raptors")])]),
    ],
...
@app.callback(Output("placeholder97", "children"), [Input("store-id25", "data")])
...
@app.callback(Output("placeholder98", "children"), [Input("store-id25", "data")])
...
@app.callback(Output("placeholder99", "children"), [Input("worth-id25", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder100", "children"), [Input("worth-id25", "data")])
