...
hs = headshotCards("Orlando Magic")
n_buttons = get_button_count("Orlando Magic")
team_ = "Orlando Magic"

layout = dbc.Container(
    [
        dcc.Store(id="store-id17"),
        dcc.Store(id="worth-id17"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Orlando Magic')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Orlando Magic", 0),
                                drawCard("Orlando Magic", 1),
                                drawCard("Orlando Magic", 2),
                                drawCard("Orlando Magic", 3),
                                drawCard("Orlando Magic", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Orlando Magic"),
                        dbc.Card(current_team_stats("Orlando Magic"), id="table-card"),
                    ],
                    width=6,
                ),
            ],
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Orlando Magic"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(player_perf("Orlando Magic"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Orlando Magic"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder665"),
                dbc.Col(children=[], width=9, id="placeholder66"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Orlando Magic"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder67", width=3),
                dbc.Col([], id="placeholder68", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Orlando Magic")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Orlando Magic")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Orlando Magic")])]),
    ],
...
@app.callback(Output("placeholder65", "children"), [Input("store-id17", "data")])
...
@app.callback(Output("placeholder66", "children"), [Input("store-id17", "data")])
...
@app.callback(Output("placeholder67", "children"), [Input("worth-id17", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder68", "children"), [Input("worth-id17", "data")])
