...
hs = headshotCards("Utah Jazz")
n_buttons = get_button_count("Utah Jazz")
team_ = "Utah Jazz"

layout = dbc.Container(
    [
        dcc.Store(id="store-id26"),
        dcc.Store(id="worth-id26"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Utah Jazz')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Utah Jazz", 0),
                                drawCard("Utah Jazz", 1),
                                drawCard("Utah Jazz", 2),
                                drawCard("Utah Jazz", 3),
                                drawCard("Utah Jazz", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Utah Jazz"),
                        dbc.Card(current_team_stats("Utah Jazz"), id="table-card"),
                    ],
                    width=6,
                ),
            ],
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(team_schedule("Utah Jazz"), id="table-card2")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(player_perf("Utah Jazz"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Utah Jazz"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder101"),
                dbc.Col(children=[], width=9, id="placeholder102"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Utah Jazz"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder103", width=3),
                dbc.Col([], id="placeholder104", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Utah Jazz")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Utah Jazz")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Utah Jazz")])]),
    ],
...
@app.callback(Output("placeholder101", "children"), [Input("store-id26", "data")])
...
@app.callback(Output("placeholder102", "children"), [Input("store-id26", "data")])
...
@app.callback(Output("placeholder103", "children"), [Input("worth-id26", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder104", "children"), [Input("worth-id26", "data")])
