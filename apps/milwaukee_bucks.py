...
hs = headshotCards("Milwaukee Bucks")
n_buttons = get_button_count("Milwaukee Bucks")
team_ = "Milwaukee Bucks"

layout = dbc.Container(
    [
        dcc.Store(id="store-id13"),
        dcc.Store(id="worth-id13"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Milwaukee Bucks')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Milwaukee Bucks", 0),
                                drawCard("Milwaukee Bucks", 1),
                                drawCard("Milwaukee Bucks", 2),
                                drawCard("Milwaukee Bucks", 3),
                                drawCard("Milwaukee Bucks", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Milwaukee Bucks"),
                        dbc.Card(
                            current_team_stats("Milwaukee Bucks"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Milwaukee Bucks"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Milwaukee Bucks"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Milwaukee Bucks"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder49"),
                dbc.Col(children=[], width=9, id="placeholder50"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Milwaukee Bucks"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder51", width=3),
                dbc.Col([], id="placeholder52", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Milwaukee Bucks")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Milwaukee Bucks")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Milwaukee Bucks")])]),
    ],
...
@app.callback(Output("placeholder49", "children"), [Input("store-id13", "data")])
...
@app.callback(Output("placeholder50", "children"), [Input("store-id13", "data")])
...
@app.callback(Output("placeholder51", "children"), [Input("worth-id13", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder52", "children"), [Input("worth-id13", "data")])
