...
hs = headshotCards("Cleveland Cavaliers")
n_buttons = get_button_count("Cleveland Cavaliers")
team_ = "Cleveland Cavaliers"

layout = dbc.Container(
    [
        dcc.Store(id="store-id3"),
        dcc.Store(id="worth-id3"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Cleveland Cavaliers')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Cleveland Cavaliers", 0),
                                drawCard("Cleveland Cavaliers", 1),
                                drawCard("Cleveland Cavaliers", 2),
                                drawCard("Cleveland Cavaliers", 3),
                                drawCard("Cleveland Cavaliers", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Cleveland Cavaliers"),
                        dbc.Card(
                            current_team_stats("Cleveland Cavaliers"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(team_schedule("Cleveland Cavaliers"), id="table-card2")]
                )
            ]
        ),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Cleveland Cavaliers"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Cleveland Cavaliers"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder9"),
                dbc.Col(children=[], width=9, id="placeholder10"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Cleveland Cavaliers"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder11", width=3),
                dbc.Col([], id="placeholder12", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Cleveland Cavaliers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Cleveland Cavaliers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Cleveland Cavaliers")])]),
    ],
...
@app.callback(Output("placeholder9", "children"), [Input("store-id3", "data")])
...
@app.callback(Output("placeholder10", "children"), [Input("store-id3", "data")])
...
@app.callback(Output("placeholder11", "children"), [Input("worth-id3", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder12", "children"), [Input("worth-id3", "data")])
