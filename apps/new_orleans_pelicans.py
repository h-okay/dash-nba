...
hs = headshotCards("New Orleans Pelicans")
n_buttons = get_button_count("New Orleans Pelicans")
team_ = "New Orleans Pelicans"

layout = dbc.Container(
    [
        dcc.Store(id="store-id4"),
        dcc.Store(id="worth-id4"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('New Orleans Pelicans')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("New Orleans Pelicans", 0),
                                drawCard("New Orleans Pelicans", 1),
                                drawCard("New Orleans Pelicans", 2),
                                drawCard("New Orleans Pelicans", 3),
                                drawCard("New Orleans Pelicans", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("New Orleans Pelicans"),
                        dbc.Card(
                            current_team_stats("New Orleans Pelicans"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(team_schedule("New Orleans Pelicans"), id="table-card2")]
                )
            ]
        ),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("New Orleans Pelicans"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("New Orleans Pelicans"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder13"),
                dbc.Col(children=[], width=9, id="placeholder14"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("New Orleans Pelicans"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder15", width=3),
                dbc.Col([], id="placeholder16", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("New Orleans Pelicans")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("New Orleans Pelicans")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("New Orleans Pelicans")])]),
    ],
...
@app.callback(Output("placeholder13", "children"), [Input("store-id4", "data")])
...
@app.callback(Output("placeholder14", "children"), [Input("store-id4", "data")])
...
@app.callback(Output("placeholder15", "children"), [Input("worth-id4", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder16", "children"), [Input("worth-id4", "data")])
