...
hs = headshotCards("Minnesota Timberwolves")
n_buttons = get_button_count("Minnesota Timberwolves")
team_ = "Minnesota Timberwolves"

layout = dbc.Container(
    [
        dcc.Store(id="store-id14"),
        dcc.Store(id="worth-id14"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Minnesota Timberwolves')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Minnesota Timberwolves", 0),
                                drawCard("Minnesota Timberwolves", 1),
                                drawCard("Minnesota Timberwolves", 2),
                                drawCard("Minnesota Timberwolves", 3),
                                drawCard("Minnesota Timberwolves", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Minnesota Timberwolves"),
                        dbc.Card(
                            current_team_stats("Minnesota Timberwolves"),
                            id="table-card",
                        ),
                    ],
                    width=6,
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            team_schedule("Minnesota Timberwolves"), id="table-card2"
                        )
                    ]
                )
            ]
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(player_perf("Minnesota Timberwolves"), id="table-card3")]
                )
            ]
        ),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Minnesota Timberwolves"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder53"),
                dbc.Col(children=[], width=9, id="placeholder54"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Minnesota Timberwolves"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder55", width=3),
                dbc.Col([], id="placeholder56", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Minnesota Timberwolves")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Minnesota Timberwolves")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Minnesota Timberwolves")])]),
    ],
...
@app.callback(Output("placeholder53", "children"), [Input("store-id14", "data")])
...
@app.callback(Output("placeholder54", "children"), [Input("store-id14", "data")])
...
@app.callback(Output("placeholder55", "children"), [Input("worth-id14", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder56", "children"), [Input("worth-id14", "data")])
