...
hs = headshotCards("Los Angeles Clippers")
n_buttons = get_button_count("Los Angeles Clippers")
team_ = "Los Angeles Clippers"

layout = dbc.Container(
    [
        dcc.Store(id="store-id10"),
        dcc.Store(id="worth-id10"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Los Angeles Clippers')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Los Angeles Clippers", 0),
                                drawCard("Los Angeles Clippers", 1),
                                drawCard("Los Angeles Clippers", 2),
                                drawCard("Los Angeles Clippers", 3),
                                drawCard("Los Angeles Clippers", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Los Angeles Clippers"),
                        dbc.Card(
                            current_team_stats("Los Angeles Clippers"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(team_schedule("Los Angeles Clippers"), id="table-card2")]
                )
            ]
        ),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Los Angeles Clippers"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Los Angeles Clippers"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder37"),
                dbc.Col(children=[], width=9, id="placeholder38"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Los Angeles Clippers"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder39", width=3),
                dbc.Col([], id="placeholder40", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Los Angeles Clippers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Los Angeles Clippers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Los Angeles Clippers")])]),
    ],
...
@app.callback(Output("placeholder37", "children"), [Input("store-id10", "data")])
...
@app.callback(Output("placeholder38", "children"), [Input("store-id10", "data")])
...
@app.callback(Output("placeholder39", "children"), [Input("worth-id10", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder40", "children"), [Input("worth-id10", "data")])
