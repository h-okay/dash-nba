...
hs = headshotCards("Denver Nuggets")
n_buttons = get_button_count("Denver Nuggets")
team_ = "Denver Nuggets"

layout = dbc.Container(
    [
        dcc.Store(id="store-id7"),
        dcc.Store(id="worth-id7"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Denver Nuggets')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Denver Nuggets", 0),
                                drawCard("Denver Nuggets", 1),
                                drawCard("Denver Nuggets", 2),
                                drawCard("Denver Nuggets", 3),
                                drawCard("Denver Nuggets", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Denver Nuggets"),
                        dbc.Card(current_team_stats("Denver Nuggets"), id="table-card"),
                    ],
                    width=6,
                ),
            ],
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Denver Nuggets"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(player_perf("Denver Nuggets"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Denver Nuggets"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder25"),
                dbc.Col(children=[], width=9, id="placeholder26"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Denver Nuggets"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder27", width=3),
                dbc.Col([], id="placeholder28", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Denver Nuggets")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Denver Nuggets")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Denver Nuggets")])]),
    ],
...
@app.callback(Output("placeholder25", "children"), [Input("store-id7", "data")])
...
@app.callback(Output("placeholder26", "children"), [Input("store-id7", "data")])
...
@app.callback(Output("placeholder27", "children"), [Input("worth-id7", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder28", "children"), [Input("worth-id7", "data")])
