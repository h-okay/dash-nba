...
hs = headshotCards("Houston Rockets")
n_buttons = get_button_count("Houston Rockets")
team_ = "Houston Rockets"

layout = dbc.Container(
    [
        dcc.Store(id="store-id9"),
        dcc.Store(id="worth-id9"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Houston Rockets')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Houston Rockets", 0),
                                drawCard("Houston Rockets", 1),
                                drawCard("Houston Rockets", 2),
                                drawCard("Houston Rockets", 3),
                                drawCard("Houston Rockets", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Houston Rockets"),
                        dbc.Card(
                            current_team_stats("Houston Rockets"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Houston Rockets"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Houston Rockets"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Houston Rockets"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder33"),
                dbc.Col(children=[], width=9, id="placeholder34"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Houston Rockets"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder35", width=3),
                dbc.Col([], id="placeholder36", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Houston Rockets")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Houston Rockets")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Houston Rockets")])]),
    ],
...
@app.callback(Output("placeholder33", "children"), [Input("store-id9", "data")])
...
@app.callback(Output("placeholder34", "children"), [Input("store-id9", "data")])
...
@app.callback(Output("placeholder35", "children"), [Input("worth-id9", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder36", "children"), [Input("worth-id9", "data")])
