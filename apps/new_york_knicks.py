...
hs = headshotCards("New York Knicks")
n_buttons = get_button_count("New York Knicks")
team_ = "New York Knicks"

layout = dbc.Container(
    [
        dcc.Store(id="store-id16"),
        dcc.Store(id="worth-id16"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('New York Knicks')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("New York Knicks", 0),
                                drawCard("New York Knicks", 1),
                                drawCard("New York Knicks", 2),
                                drawCard("New York Knicks", 3),
                                drawCard("New York Knicks", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("New York Knicks"),
                        dbc.Card(
                            current_team_stats("New York Knicks"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("New York Knicks"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("New York Knicks"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("New York Knicks"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder61"),
                dbc.Col(children=[], width=9, id="placeholder62"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("New York Knicks"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder63", width=3),
                dbc.Col([], id="placeholder64", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("New York Knicks")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("New York Knicks")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("New York Knicks")])]),
    ],
...
@app.callback(Output("placeholder61", "children"), [Input("store-id16", "data")])
...
@app.callback(Output("placeholder62", "children"), [Input("store-id16", "data")])
...
@app.callback(Output("placeholder63", "children"), [Input("worth-id16", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder64", "children"), [Input("worth-id16", "data")])
