...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Golden State Warriors"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(team_schedule("Golden State Warriors"), id="table-card2")]
                )
            ]
        ),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(player_perf("Golden State Warriors"), id="table-card3")]
                )
            ]
        ),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Golden State Warriors"),
                            id="forecast-card",
...
@app.callback(Output("placeholder29", "children"), [Input("store-id8", "data")])
...
@app.callback(Output("placeholder30", "children"), [Input("store-id8", "data")])
...
@app.callback(Output("placeholder31", "children"), [Input("worth-id8", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder32", "children"), [Input("worth-id8", "data")])
