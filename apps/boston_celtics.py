...
hs = headshotCards("Boston Celtics")
n_buttons = get_button_count("Boston Celtics")
team_ = "Boston Celtics"

layout = dbc.Container(
    [
        dcc.Store(id="store-id2"),
        dcc.Store(id="worth-id2"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Boston Celtics')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Boston Celtics", 0),
                                drawCard("Boston Celtics", 1),
                                drawCard("Boston Celtics", 2),
                                drawCard("Boston Celtics", 3),
                                drawCard("Boston Celtics", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Boston Celtics"),
                        dbc.Card(current_team_stats("Boston Celtics"), id="table-card"),
                    ],
                    width=6,
                ),
            ],
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Boston Celtics"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(player_perf("Boston Celtics"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Boston Celtics"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder5"),
                dbc.Col(children=[], width=9, id="placeholder6"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Boston Celtics"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder7", width=3),
                dbc.Col([], id="placeholder8", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Boston Celtics")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Boston Celtics")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Boston Celtics")])]),
    ],
...
@app.callback(Output("placeholder5", "children"), [Input("store-id2", "data")])
...
@app.callback(Output("placeholder6", "children"), [Input("store-id2", "data")])
...
@app.callback(Output("placeholder7", "children"), [Input("worth-id2", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder8", "children"), [Input("worth-id2", "data")])
