...
hs = headshotCards("Chicago Bulls")
n_buttons = get_button_count("Chicago Bulls")
team_ = "Chicago Bulls"

layout = dbc.Container(
    [
        dcc.Store(id="store-id5"),
        dcc.Store(id="worth-id5"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Chicago Bulls')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Chicago Bulls", 0),
                                drawCard("Chicago Bulls", 1),
                                drawCard("Chicago Bulls", 2),
                                drawCard("Chicago Bulls", 3),
                                drawCard("Chicago Bulls", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Chicago Bulls"),
                        dbc.Card(current_team_stats("Chicago Bulls"), id="table-card"),
                    ],
                    width=6,
                ),
            ],
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Chicago Bulls"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(player_perf("Chicago Bulls"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Chicago Bulls"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder17"),
                dbc.Col(children=[], width=9, id="placeholder18"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Chicago Bulls"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder19", width=3),
                dbc.Col([], id="placeholder20", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Chicago Bulls")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Chicago Bulls")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Chicago Bulls")])]),
    ],
...
@app.callback(Output("placeholder17", "children"), [Input("store-id5", "data")])
...
@app.callback(Output("placeholder18", "children"), [Input("store-id5", "data")])
...
@app.callback(Output("placeholder19", "children"), [Input("worth-id5", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder20", "children"), [Input("worth-id5", "data")])
