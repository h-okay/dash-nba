...
hs = headshotCards("Charlotte Hornets")
n_buttons = get_button_count("Charlotte Hornets")
team_ = "Charlotte Hornets"

layout = dbc.Container(
    [
        dcc.Store(id="store-id30"),
        dcc.Store(id="worth-id30"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Charlotte Hornets')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Charlotte Hornets", 0),
                                drawCard("Charlotte Hornets", 1),
                                drawCard("Charlotte Hornets", 2),
                                drawCard("Charlotte Hornets", 3),
                                drawCard("Charlotte Hornets", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Charlotte Hornets"),
                        dbc.Card(
                            current_team_stats("Charlotte Hornets"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Charlotte Hornets"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Charlotte Hornets"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Charlotte Hornets"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder117"),
                dbc.Col(children=[], width=9, id="placeholder118"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Charlotte Hornets"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder119", width=3),
                dbc.Col([], id="placeholder120", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Charlotte Hornets")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Charlotte Hornets")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Charlotte Hornets")])]),
    ],
...
@app.callback(Output("placeholder117", "children"), [Input("store-id30", "data")])
...
@app.callback(Output("placeholder118", "children"), [Input("store-id30", "data")])
...
@app.callback(Output("placeholder119", "children"), [Input("worth-id30", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder120", "children"), [Input("worth-id30", "data")])
