...
hs = headshotCards("Washington Wizards")
n_buttons = get_button_count("Washington Wizards")
team_ = "Washington Wizards"

layout = dbc.Container(
    [
        dcc.Store(id="store-id28"),
        dcc.Store(id="worth-id28"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Washington Wizards')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Washington Wizards", 0),
                                drawCard("Washington Wizards", 1),
                                drawCard("Washington Wizards", 2),
                                drawCard("Washington Wizards", 3),
                                drawCard("Washington Wizards", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Washington Wizards"),
                        dbc.Card(
                            current_team_stats("Washington Wizards"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Washington Wizards"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Washington Wizards"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Washington Wizards"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder109"),
                dbc.Col(children=[], width=9, id="placeholder110"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Washington Wizards"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder111", width=3),
                dbc.Col([], id="placeholder112", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Washington Wizards")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Washington Wizards")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Washington Wizards")])]),
    ],
...
@app.callback(Output("placeholder109", "children"), [Input("store-id28", "data")])
...
@app.callback(Output("placeholder110", "children"), [Input("store-id28", "data")])
...
@app.callback(Output("placeholder111", "children"), [Input("worth-id28", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder112", "children"), [Input("worth-id28", "data")])
