...
hs = headshotCards("Detroit Pistons")
n_buttons = get_button_count("Detroit Pistons")
team_ = "Detroit Pistons"

layout = dbc.Container(
    [
        dcc.Store(id="store-id29"),
        dcc.Store(id="worth-id29"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Detroit Pistons')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Detroit Pistons", 0),
                                drawCard("Detroit Pistons", 1),
                                drawCard("Detroit Pistons", 2),
                                drawCard("Detroit Pistons", 3),
                                drawCard("Detroit Pistons", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Detroit Pistons"),
                        dbc.Card(
                            current_team_stats("Detroit Pistons"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Detroit Pistons"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Detroit Pistons"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Detroit Pistons"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder113"),
                dbc.Col(children=[], width=9, id="placeholder114"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Detroit Pistons"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder115", width=3),
                dbc.Col([], id="placeholder116", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Detroit Pistons")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Detroit Pistons")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Detroit Pistons")])]),
    ],
...
@app.callback(Output("placeholder113", "children"), [Input("store-id29", "data")])
...
@app.callback(Output("placeholder114", "children"), [Input("store-id29", "data")])
...
@app.callback(Output("placeholder115", "children"), [Input("worth-id29", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder116", "children"), [Input("worth-id29", "data")])
