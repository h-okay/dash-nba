...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Philadelphia 76ers"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Philadelphia 76ers"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Philadelphia 76ers"),
                               id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder73", "children"),
              [Input("store-id19", "data")])
...
@app.callback(Output("placeholder74", "children"),
              [Input("store-id19", "data")])
...
@app.callback(Output("placeholder75", "children"),
              [Input("worth-id19", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder76", "children"),
              [Input("worth-id19", "data")])
