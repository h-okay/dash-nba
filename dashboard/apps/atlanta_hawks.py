...
hs = headshotCards("Atlanta Hawks")
n_buttons = get_button_count("Atlanta Hawks")
team_ = "Atlanta Hawks"

layout = dbc.Container(
    [
        dcc.Store(id="store-id1"),
        dcc.Store(id="worth-id1"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Atlanta Hawks')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Atlanta Hawks", 0),
                                drawCard("Atlanta Hawks", 1),
                                drawCard("Atlanta Hawks", 2),
                                drawCard("Atlanta Hawks", 3),
                                drawCard("Atlanta Hawks", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Atlanta Hawks"),
                        dbc.Card(current_team_stats("Atlanta Hawks"), id="table-card"),
                    ],
                    width=6,
                ),
            ],
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Atlanta Hawks"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(player_perf("Atlanta Hawks"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Atlanta Hawks"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Atlanta Hawks"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Atlanta Hawks")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Atlanta Hawks")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Atlanta Hawks")])]),
    ],
...
@app.callback(Output("placeholder1", "children"), [Input("store-id1", "data")])
...
@app.callback(Output("placeholder2", "children"), [Input("store-id1", "data")])
...
@app.callback(Output("placeholder3", "children"), [Input("worth-id1", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder4", "children"), [Input("worth-id1", "data")])
