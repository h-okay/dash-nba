...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(current_team_stats("Denver Nuggets"),
                                 id="table-card"),
                    ],
                    width=6,
                ),
        ...
        dbc.Row(
            [dbc.Col(
                [dbc.Card(team_schedule("Denver Nuggets"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col(
            [dbc.Card(player_perf("Denver Nuggets"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder25", "children"),
              [Input("store-id7", "data")])
...
@app.callback(Output("placeholder26", "children"),
              [Input("store-id7", "data")])
...
@app.callback(Output("placeholder27", "children"),
              [Input("worth-id7", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder28", "children"),
              [Input("worth-id7", "data")])
