...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("San Antonio Spurs"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("San Antonio Spurs"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("San Antonio Spurs"),
                               id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder89", "children"),
              [Input("store-id23", "data")])
...
@app.callback(Output("placeholder90", "children"),
              [Input("store-id23", "data")])
...
@app.callback(Output("placeholder91", "children"),
              [Input("worth-id23", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder92", "children"),
              [Input("worth-id23", "data")])
