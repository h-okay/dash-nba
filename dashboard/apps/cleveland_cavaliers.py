...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Cleveland Cavaliers"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(team_schedule("Cleveland Cavaliers"),
                              id="table-card2")]
                )
            ]
        ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Cleveland Cavaliers"),
                               id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder10", "children"),
              [Input("store-id3", "data")])
...
@app.callback(Output("placeholder11", "children"),
              [Input("worth-id3", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder12", "children"),
              [Input("worth-id3", "data")])
