...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Toronto Raptors"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Toronto Raptors"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [dbc.Col(
                [dbc.Card(player_perf("Toronto Raptors"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder97", "children"),
              [Input("store-id25", "data")])
...
@app.callback(Output("placeholder98", "children"),
              [Input("store-id25", "data")])
...
@app.callback(Output("placeholder99", "children"),
              [Input("worth-id25", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder100", "children"),
              [Input("worth-id25", "data")])
