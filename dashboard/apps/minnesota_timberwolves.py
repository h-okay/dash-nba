...
layout = dbc.Container(
    [
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            team_schedule("Minnesota Timberwolves"),
                            id="table-card2"
                        )
                    ]
                )
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(player_perf("Minnesota Timberwolves"),
                              id="table-card3")]
                )
            ]
        ),
...
@app.callback(Output("placeholder53", "children"),
              [Input("store-id14", "data")])
...
@app.callback(Output("placeholder54", "children"),
              [Input("store-id14", "data")])
...
@app.callback(Output("placeholder55", "children"),
              [Input("worth-id14", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder56", "children"),
              [Input("worth-id14", "data")])
