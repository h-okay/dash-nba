...
hs = headshotCards("Sacramento Kings")
n_buttons = get_button_count("Sacramento Kings")
team_ = "Sacramento Kings"

layout = dbc.Container(
    [
        dcc.Store(id="store-id22"),
        dcc.Store(id="worth-id22"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Sacramento Kings')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Sacramento Kings", 0),
                                drawCard("Sacramento Kings", 1),
                                drawCard("Sacramento Kings", 2),
                                drawCard("Sacramento Kings", 3),
                                drawCard("Sacramento Kings", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Sacramento Kings"),
                        dbc.Card(
                            current_team_stats("Sacramento Kings"), id="table-card"
                        ),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Sacramento Kings"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Sacramento Kings"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Sacramento Kings"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder85"),
                dbc.Col(children=[], width=9, id="placeholder86"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Sacramento Kings"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder87", width=3),
                dbc.Col([], id="placeholder88", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Sacramento Kings")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Sacramento Kings")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Sacramento Kings")])]),
    ],
...
@app.callback(Output("placeholder85", "children"), [Input("store-id22", "data")])
...
@app.callback(Output("placeholder86", "children"), [Input("store-id22", "data")])
...
@app.callback(Output("placeholder87", "children"), [Input("worth-id22", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder88", "children"), [Input("worth-id22", "data")])
