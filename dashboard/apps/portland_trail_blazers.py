...
layout = dbc.Container(
    [
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            team_schedule("Portland Trail Blazers"),
                            id="table-card2"
                        )
                    ]
                )
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(player_perf("Portland Trail Blazers"),
                              id="table-card3")]
                )
            ]
        ),
...
@app.callback(Output("placeholder81", "children"),
              [Input("store-id21", "data")])
...
@app.callback(Output("placeholder82", "children"),
              [Input("store-id21", "data")])
...
@app.callback(Output("placeholder83", "children"),
              [Input("worth-id21", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder84", "children"),
              [Input("worth-id21", "data")])
