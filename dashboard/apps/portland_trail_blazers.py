...
hs = headshotCards("Portland Trail Blazers")
n_buttons = get_button_count("Portland Trail Blazers")
team_ = "Portland Trail Blazers"

layout = dbc.Container(
    [
        dcc.Store(id="store-id21"),
        dcc.Store(id="worth-id21"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Portland Trail Blazers')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Portland Trail Blazers", 0),
                                drawCard("Portland Trail Blazers", 1),
                                drawCard("Portland Trail Blazers", 2),
                                drawCard("Portland Trail Blazers", 3),
                                drawCard("Portland Trail Blazers", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Portland Trail Blazers"),
                        dbc.Card(
                            current_team_stats("Portland Trail Blazers"),
                            id="table-card",
                        ),
                    ],
                    width=6,
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            team_schedule("Portland Trail Blazers"), id="table-card2"
                        )
                    ]
                )
            ]
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(player_perf("Portland Trail Blazers"), id="table-card3")]
                )
            ]
        ),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Portland Trail Blazers"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder81"),
                dbc.Col(children=[], width=9, id="placeholder82"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Portland Trail Blazers"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder83", width=3),
                dbc.Col([], id="placeholder84", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Portland Trail Blazers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Portland Trail Blazers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Portland Trail Blazers")])]),
    ],
...
@app.callback(Output("placeholder81", "children"), [Input("store-id21", "data")])
...
@app.callback(Output("placeholder82", "children"), [Input("store-id21", "data")])
...
@app.callback(Output("placeholder83", "children"), [Input("worth-id21", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder84", "children"), [Input("worth-id21", "data")])
