...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Los Angeles Lakers"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Los Angeles Lakers"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Los Angeles Lakers"),
                               id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder41", "children"),
              [Input("store-id11", "data")])
...
@app.callback(Output("placeholder42", "children"),
              [Input("store-id11", "data")])
...
@app.callback(Output("placeholder43", "children"),
              [Input("worth-id11", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder44", "children"),
              [Input("worth-id11", "data")])
