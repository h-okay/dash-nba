...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(current_team_stats("Utah Jazz"),
                                 id="table-card"),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row([dbc.Col(
            [dbc.Card(team_schedule("Utah Jazz"), id="table-card2")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Utah Jazz"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder101", "children"),
              [Input("store-id26", "data")])
...
@app.callback(Output("placeholder102", "children"),
              [Input("store-id26", "data")])
...
@app.callback(Output("placeholder103", "children"),
              [Input("worth-id26", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder104", "children"),
              [Input("worth-id26", "data")])
