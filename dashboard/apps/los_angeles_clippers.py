...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Los Angeles Clippers"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(team_schedule("Los Angeles Clippers"),
                              id="table-card2")]
                )
            ]
        ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Los Angeles Clippers"),
                               id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder37", "children"),
              [Input("store-id10", "data")])
...
@app.callback(Output("placeholder38", "children"),
              [Input("store-id10", "data")])
...
@app.callback(Output("placeholder39", "children"),
              [Input("worth-id10", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder40", "children"),
              [Input("worth-id10", "data")])
