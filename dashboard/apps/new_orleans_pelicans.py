...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("New Orleans Pelicans"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        dbc.Row(
            [
                dbc.Col(
                    [dbc.Card(team_schedule("New Orleans Pelicans"),
                              id="table-card2")]
                )
            ]
        ),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("New Orleans Pelicans"),
                               id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder13", "children"),
              [Input("store-id4", "data")])
...
@app.callback(Output("placeholder14", "children"),
              [Input("store-id4", "data")])
...
@app.callback(Output("placeholder15", "children"),
              [Input("worth-id4", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder16", "children"),
              [Input("worth-id4", "data")])
