...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Charlotte Hornets"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Charlotte Hornets"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Charlotte Hornets"),
                               id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder117", "children"),
              [Input("store-id30", "data")])
...
@app.callback(Output("placeholder118", "children"),
              [Input("store-id30", "data")])
...
@app.callback(Output("placeholder119", "children"),
              [Input("worth-id30", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder120", "children"),
              [Input("worth-id30", "data")])
