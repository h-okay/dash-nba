...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Dallas Mavericks"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Dallas Mavericks"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [dbc.Col(
                [dbc.Card(player_perf("Dallas Mavericks"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder21", "children"),
              [Input("store-id6", "data")])
...
@app.callback(Output("placeholder22", "children"),
              [Input("store-id6", "data")])
...
@app.callback(Output("placeholder23", "children"),
              [Input("worth-id6", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder24", "children"),
              [Input("worth-id6", "data")])
