...
hs = headshotCards("Indiana Pacers")
n_buttons = get_button_count("Indiana Pacers")
team_ = "Indiana Pacers"

layout = dbc.Container(
    [
        dcc.Store(id="store-id18"),
        dcc.Store(id="worth-id18"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Indiana Pacers')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Indiana Pacers", 0),
                                drawCard("Indiana Pacers", 1),
                                drawCard("Indiana Pacers", 2),
                                drawCard("Indiana Pacers", 3),
                                drawCard("Indiana Pacers", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Indiana Pacers"),
                        dbc.Card(current_team_stats("Indiana Pacers"), id="table-card"),
                    ],
                    width=6,
                ),
            ],
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Indiana Pacers"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(player_perf("Indiana Pacers"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Indiana Pacers"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder69"),
                dbc.Col(children=[], width=9, id="placeholder70"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Indiana Pacers"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder71", width=3),
                dbc.Col([], id="placeholder72", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Indiana Pacers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Indiana Pacers")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Indiana Pacers")])]),
    ],
...
@app.callback(Output("placeholder69", "children"), [Input("store-id18", "data")])
...
@app.callback(Output("placeholder70", "children"), [Input("store-id18", "data")])
...
@app.callback(Output("placeholder71", "children"), [Input("worth-id18", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder72", "children"), [Input("worth-id18", "data")])
