...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(current_team_stats("Orlando Magic"),
                                 id="table-card"),
                    ],
                    width=6,
                ),
        ...
        dbc.Row(
            [dbc.Col(
                [dbc.Card(team_schedule("Orlando Magic"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col(
            [dbc.Card(player_perf("Orlando Magic"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder65", "children"),
              [Input("store-id17", "data")])
...
@app.callback(Output("placeholder66", "children"),
              [Input("store-id17", "data")])
...
@app.callback(Output("placeholder67", "children"),
              [Input("worth-id17", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder68", "children"),
              [Input("worth-id17", "data")])
