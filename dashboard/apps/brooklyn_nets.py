...
hs = headshotCards("Brooklyn Nets")
n_buttons = get_button_count("Brooklyn Nets")
team_ = "Brooklyn Nets"

layout = dbc.Container(
    [
        dcc.Store(id="store-id15"),
        dcc.Store(id="worth-id15"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Brooklyn Nets')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Brooklyn Nets", 0),
                                drawCard("Brooklyn Nets", 1),
                                drawCard("Brooklyn Nets", 2),
                                drawCard("Brooklyn Nets", 3),
                                drawCard("Brooklyn Nets", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Brooklyn Nets"),
                        dbc.Card(current_team_stats("Brooklyn Nets"), id="table-card"),
                    ],
                    width=6,
                ),
            ],
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Brooklyn Nets"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(player_perf("Brooklyn Nets"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Brooklyn Nets"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder57"),
                dbc.Col(children=[], width=9, id="placeholder58"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Brooklyn Nets"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder59", width=3),
                dbc.Col([], id="placeholder60", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Brooklyn Nets")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Brooklyn Nets")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Brooklyn Nets")])]),
    ],
...
@app.callback(Output("placeholder57", "children"), [Input("store-id15", "data")])
...
@app.callback(Output("placeholder58", "children"), [Input("store-id15", "data")])
...
@app.callback(Output("placeholder59", "children"), [Input("worth-id15", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder60", "children"), [Input("worth-id15", "data")])
