...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(current_team_stats("Brooklyn Nets"),
                                 id="table-card"),
                    ],
                    width=6,
                ),
        ...
        dbc.Row(
            [dbc.Col(
                [dbc.Card(team_schedule("Brooklyn Nets"), id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col(
            [dbc.Card(player_perf("Brooklyn Nets"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder57", "children"),
              [Input("store-id15", "data")])
...
@app.callback(Output("placeholder58", "children"),
              [Input("store-id15", "data")])
...
@app.callback(Output("placeholder59", "children"),
              [Input("worth-id15", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder60", "children"),
              [Input("worth-id15", "data")])
