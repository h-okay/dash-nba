...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Detroit Pistons"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Detroit Pistons"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [dbc.Col(
                [dbc.Card(player_perf("Detroit Pistons"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder113", "children"),
              [Input("store-id29", "data")])
...
@app.callback(Output("placeholder114", "children"),
              [Input("store-id29", "data")])
...
@app.callback(Output("placeholder115", "children"),
              [Input("worth-id29", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder116", "children"),
              [Input("worth-id29", "data")])
