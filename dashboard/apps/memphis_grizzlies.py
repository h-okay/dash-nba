...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Memphis Grizzlies"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Memphis Grizzlies"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Memphis Grizzlies"),
                               id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder105", "children"),
              [Input("store-id27", "data")])
...
@app.callback(Output("placeholder106", "children"),
              [Input("store-id27", "data")])
...
@app.callback(Output("placeholder107", "children"),
              [Input("worth-id27", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder108", "children"),
              [Input("worth-id27", "data")])
