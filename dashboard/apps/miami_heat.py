...
hs = headshotCards("Miami Heat")
n_buttons = get_button_count("Miami Heat")
team_ = "Miami Heat"

layout = dbc.Container(
    [
        dcc.Store(id="store-id12"),
        dcc.Store(id="worth-id12"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Miami Heat')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                dbc.Col(
                    [
                        dbc.CardBody(
                            [
                                drawCard("Miami Heat", 0),
                                drawCard("Miami Heat", 1),
                                drawCard("Miami Heat", 2),
                                drawCard("Miami Heat", 3),
                                drawCard("Miami Heat", 4),
                            ],
                            id="PlayerCard",
                        )
                    ],
                ...
                dbc.Col(
                    [
                        matchup_info("Miami Heat"),
                        dbc.Card(current_team_stats("Miami Heat"), id="table-card"),
                    ],
                    width=6,
                ),
            ],
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(team_schedule("Miami Heat"), id="table-card2")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([dbc.Card(player_perf("Miami Heat"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            performance_forecast_buttons("Miami Heat"),
                            id="forecast-card",
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder45"),
                dbc.Col(children=[], width=9, id="placeholder46"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Miami Heat"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder47", width=3),
                dbc.Col([], id="placeholder48", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Miami Heat")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Miami Heat")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Miami Heat")])]),
    ],
...
@app.callback(Output("placeholder45", "children"), [Input("store-id12", "data")])
...
@app.callback(Output("placeholder46", "children"), [Input("store-id12", "data")])
...
@app.callback(Output("placeholder47", "children"), [Input("worth-id12", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder48", "children"), [Input("worth-id12", "data")])
