...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(current_team_stats("Miami Heat"),
                                 id="table-card"),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row([dbc.Col(
            [dbc.Card(team_schedule("Miami Heat"), id="table-card2")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col(
            [dbc.Card(player_perf("Miami Heat"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder45", "children"),
              [Input("store-id12", "data")])
...
@app.callback(Output("placeholder46", "children"),
              [Input("store-id12", "data")])
...
@app.callback(Output("placeholder47", "children"),
              [Input("worth-id12", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder48", "children"),
              [Input("worth-id12", "data")])
