...
layout = dbc.Container(
    [
        dcc.Store(id="store-id20"),
        dcc.Store(id="worth-id20"),
            ...
            [
                dbc.Col(
                    dbc.Card(
                        dbc.Card(
                            top_card(
                                f"Team Worth: {team_worth('Phoenix Suns')} $",
                                "worth-cardbody",
                            ),
                            color="success",
                            inverse=True,
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(current_team_stats("Phoenix Suns"),
                                 id="table-card"),
                    ],
                    width=6,
                ),
        ...
        html.Hr(),
        dbc.Row([dbc.Col(
            [dbc.Card(team_schedule("Phoenix Suns"), id="table-card2")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col(
            [dbc.Card(player_perf("Phoenix Suns"), id="table-card3")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(children=[], width=3, id="placeholder77"),
                dbc.Col(children=[], width=9, id="placeholder78"),
            ]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dbc.Card(
                            worth_forecast_buttons("Phoenix Suns"),
                            id="salary-nav",
                            className="shadow-card",
                        )
                    ]
        ...
        dbc.Row(
            [
                dbc.Col([], id="placeholder79", width=3),
                dbc.Col([], id="placeholder80", width=9),
            ],
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([team_segmentation("Phoenix Suns")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([player_history("Phoenix Suns")])]),
        html.Br(),
        html.Br(),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row([dbc.Col([elo_history("Phoenix Suns")])]),
    ],
...
@app.callback(Output("placeholder77", "children"),
              [Input("store-id20", "data")])
...
@app.callback(Output("placeholder78", "children"),
              [Input("store-id20", "data")])
...
@app.callback(Output("placeholder79", "children"),
              [Input("worth-id20", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder80", "children"),
              [Input("worth-id20", "data")])
