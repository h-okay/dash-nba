...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Milwaukee Bucks"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Milwaukee Bucks"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [dbc.Col(
                [dbc.Card(player_perf("Milwaukee Bucks"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder49", "children"),
              [Input("store-id13", "data")])
...
@app.callback(Output("placeholder50", "children"),
              [Input("store-id13", "data")])
...
@app.callback(Output("placeholder51", "children"),
              [Input("worth-id13", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder52", "children"),
              [Input("worth-id13", "data")])
