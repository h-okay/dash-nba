...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("Washington Wizards"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("Washington Wizards"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(player_perf("Washington Wizards"),
                               id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder109", "children"),
              [Input("store-id28", "data")])
...
@app.callback(Output("placeholder110", "children"),
              [Input("store-id28", "data")])
...
@app.callback(Output("placeholder111", "children"),
              [Input("worth-id28", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder112", "children"),
              [Input("worth-id28", "data")])
