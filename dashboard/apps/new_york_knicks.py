...
layout = dbc.Container(
    [
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dbc.Card(
                            current_team_stats("New York Knicks"),
                            id="table-card"
                        ),
                    ],
                    width=6,
        ...
        html.Hr(),
        dbc.Row(
            [dbc.Col([dbc.Card(team_schedule("New York Knicks"),
                               id="table-card2")])]
        ),
        html.Br(),
        html.Br(),
        ...
        dbc.Row(
            [dbc.Col(
                [dbc.Card(player_perf("New York Knicks"), id="table-card3")])]
        ),
        html.Br(),
        html.Br(),
        html.Br(),
...
@app.callback(Output("placeholder61", "children"),
              [Input("store-id16", "data")])
...
@app.callback(Output("placeholder62", "children"),
              [Input("store-id16", "data")])
...
@app.callback(Output("placeholder63", "children"),
              [Input("worth-id16", "data")])
def player_performance(data, team=team_):
    if data == "":
        data = 1
    else:
...
@app.callback(Output("placeholder64", "children"),
              [Input("worth-id16", "data")])
